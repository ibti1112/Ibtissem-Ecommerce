...
<button class="btn btn-danger" @click="removeFromCart(c)">Remove</button>
</div>
</div>
...
<router-link to="{name: 'Payment'}"> <button class="btn btn-info"> Check Out </button></router-link>
